...
export class VacationService {
     ...
     */
    public createVacation(userId: number, vacation: Vacation): Observable<Vacation> {
        return this.request.post<Vacation>(`${this.BASE_USER_PATH}/${userId.toString()}/user`, vacation);
    }
     ...
     */
    public createBatchVacations(userId: number, vacations: Vacation[]): Observable<Vacation[]> {
        return this.request.post<Vacation[]>(`${this.BASE_USER_PATH}/${userId.toString()}/user/batch`, vacations);
    }
    ...
    public deleteAllVacationsByUserId(userId: number): Observable<any> {
        return this.request.delete<any>(`${this.BASE_USER_PATH}/${userId.toString()}/user`);
    }
}
