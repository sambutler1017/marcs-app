...
import { RegionalManagerStoresCardComponent } from './user-detail/cards/regional-stores-card/regional-manager-stores-card.component';
...
@NgModule({
  declarations: [
    ...
    RegionalManagerStoresCardComponent,
  ],
